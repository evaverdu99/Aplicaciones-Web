...
$appProd = es\ucm\fdi\aw\AplicacionProductos::getSingleton();
$appProd->init(array('host'=>BD_HOST, 'bd'=>BD_NAME_PRODUCTO, 'user'=>BD_USER, 'pass'=>BD_PASS));
